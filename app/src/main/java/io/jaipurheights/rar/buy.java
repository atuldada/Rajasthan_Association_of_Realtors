...
public class buy extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter4 = ArrayAdapter.createFromResource(buy.this,
        ...
        proptype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapter, View arg1,
                ...
                if (msupplier.equals("Residential property")) {
                    ArrayAdapter<CharSequence> adapterc = ArrayAdapter.createFromResource(buy.this,
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(buy.this,
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(buy.this,
        ...
        addSignatureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(buy.this, SignatureActivity.class);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(imgFile.exists() && nam!=null && mob!=null) {
                    ...
                    try {
                        InputStream is = getAssets().open("buyer.txt");
              ...
              /*  else if(mob.length()>9)
                {
                    ...
                    Toast.makeText(buy.this, "Incomplete Form", Toast.LENGTH_SHORT);
                }
