...
public class form extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter4 = ArrayAdapter.createFromResource(form.this,
        ...
        proptype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapter, View arg1,
                ...
                if (msupplier.equals("Residential property")) {
                    ArrayAdapter<CharSequence> adapterc = ArrayAdapter.createFromResource(form.this,
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(form.this,
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(form.this,
