...
public class sell extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter4 = ArrayAdapter.createFromResource(sell.this,
        ...
        proptype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapter, View arg1,
                ...
                if (msupplier.equals("Residential property")) {
                    ArrayAdapter<CharSequence> adapterc = ArrayAdapter.createFromResource(sell.this,
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(sell.this,
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(sell.this,
        ...
        addSignatureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(sell.this, SignatureActivity.class);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(imgFile.exists()) {
                    ...
                    try {
                        InputStream is = getAssets().open("sellor.txt");
